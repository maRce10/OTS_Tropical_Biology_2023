...
1. Make a list containing the matrix from `4` and the data frame from `5`
...
- Extract the first column from the example data `iris`

- Extract the second row from the example data `iris`

- Extract the second column and second and third row from the example data `iris`

- How many columns and how many rows does `iris` has?
